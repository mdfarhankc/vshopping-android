...
//                        Toast.makeText(getApplicationContext(), response, Toast.LENGTH_LONG).show();
            ...
            protected Map<String, String> getParams() {
                ...
                String la=Locationservice.lati;
                String lo=Locationservice.logi;
//                Toast.makeText(view_near_by_store.this, ""+la+lo, Toast.LENGTH_SHORT).show();
                params.put("la", la);//passing to python
                params.put("lo", lo);//passing to python
