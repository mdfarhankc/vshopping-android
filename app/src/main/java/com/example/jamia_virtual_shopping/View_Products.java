...
public class View_Products extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    String[]  id,name, price ,quantity ,mfd_date,photo;
    String ip, url, sid;
...
//
                                ...
                                for (int i = 0; i < js.length(); i++) {
                                    ...
                                    mfd_date[i] = u.getString("mfd_date");
...
//                                    Toast.makeText(getApplicationContext(), "rr"+com[i], Toast.LENGTH_SHORT).show();
                                ...
                                li.setAdapter(new custom_view_product(getApplicationContext(), id,name, price ,quantity ,mfd_date,photo));//custom_view_service.xml and li is the listview object
