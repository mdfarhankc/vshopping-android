...
public class custom_view_product extends BaseAdapter {
    ...
    public custom_view_product(Context applicationContext, String[] id, String[] name, String[] price, String[] quantity, String[] mfd_date, String[] photo) {
